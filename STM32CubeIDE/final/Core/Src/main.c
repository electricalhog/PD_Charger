...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, INPUT_EN_Pin|OUTPUT_EN_Pin|OUTPUT_DIS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : INPUT_EN_Pin OUTPUT_EN_Pin OUTPUT_DIS_Pin */
  GPIO_InitStruct.Pin = INPUT_EN_Pin|OUTPUT_EN_Pin|OUTPUT_DIS_Pin;
