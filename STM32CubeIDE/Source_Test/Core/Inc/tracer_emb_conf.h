...
#define TRACER_EMB_TX_DMA_IRQ                        DMA1_Channel1_IRQn
#define TRACER_EMB_TX_DMA_IRQHANDLER                 DMA1_Channel1_IRQHandler
#define TRACER_EMB_TX_DMA_ACTIVE_FLAG                LL_DMA_IsActiveFlag_TC1
#define TRACER_EMB_TX_DMA_CLEAR_FLAG                 LL_DMA_ClearFlag_TC1
